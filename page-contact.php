...
<head>
    ...
    <title>GODLIKE | Contact Us</title>
    ...
    <script>
        function initializeGmaps() {
            ...
            var styledMapType = new google.maps.StyledMapType([{
                ...
                stylers: [{color: "#000000"}, {lightness: 1}, {weight: 1.2}]
            }, {
                featureType: "administrative.country",
                elementType: "labels.text.fill",
                stylers: [{color: "#e08821"}]
            }, {
                ...
                featureType: "poi",
                elementType: "geometry",
                stylers: [{color: "#000000"}, {lightness: 13}, {visibility: "on"}]
            }, {
                ...
                elementType: "geometry.fill",
                stylers: [{color: "#e08821"}, {lightness: "0"}]
            }, {
                featureType: "road.highway",
                elementType: "geometry.stroke",
                stylers: [{visibility: "off"}]
                ...
                elementType: "geometry",
                stylers: [{color: "#000000"}, {lightness: 10}]
            }, {featureType: "water", elementType: "geometry", stylers: [{color: "#000000"}]}], {name: 'GodlikeStyle'});
