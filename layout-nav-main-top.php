...
<head>
    ...
    <title>GODLIKE | Navigation Main Top Only</title>
    ...
    <nav class="nk-navbar nk-navbar-top nk-navbar-sticky nk-navbar-autohide">
        <div class="container">
            <div class="nk-nav-table">
                ...
                <ul class="nk-nav nk-nav-center d-none d-lg-block" data-nav-mobile="#nk-nav-mobile">
    ...
    <div class="nk-header-table">
        <div class="nk-header-table-cell">
            <div class="container">
                    ...
                    <h1 class="nk-title">Navigation Main Top Only</h1>
