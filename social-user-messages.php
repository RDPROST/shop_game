        ...
        <div class="row vertical-gap">
            ...
            <div class="col-lg-9">
                ...
                <div class="nk-social-menu-inline">
                    <ul>
                        <li class="active">
                            <a href="social-user-messages.html">Inbox</a>
                        </li>
                        <li>
                            <a href="social-user-messages-compose.html">Compose</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr class="nk-social-messages-unread">
                                ...
                                <td class="nk-social-messages-description">
                                    ...
                                    <a href="#" class="nk-social-messages-favorite"><span
                                                class="ion-android-star"></span></a>
                                    <div class="nk-social-messages-from">
                                        <a href="#"><img src="assets/images/avatar-2-sm.jpg" alt="John"
                                                         title="John"></a>
                                    </div>
                                    <div class="nk-social-messages-subject">
                                        <a href="social-user-messages-single.html">Hey, man!</a>
                                    </div>
                                    <div class="nk-social-messages-excerpt">
                                        <a href="social-user-messages-single.html">Again all builder annoying enjoy
                                            anyone teachings rejects and can obtain those. Us, pursue laborious
                                            toil...</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="nk-social-messages-description">
                                    ...
                                    <a href="#" class="nk-social-messages-remove"><span class="ion-trash-b"></span></a>
                                    <a href="#" class="nk-social-messages-favorite"><span
                                                class="ion-android-star-outline"></span></a>
                                    <div class="nk-social-messages-from">
                                        <a href="#"><img src="assets/images/avatar-3-sm.jpg" alt="Mary"
                                                         title="Mary"></a>
                                    </div>
                                    <div class="nk-social-messages-subject">
                                        <a href="social-user-messages-single.html">Explorer</a>
                                    </div>
                                    <div class="nk-social-messages-excerpt">
                                        <a href="social-user-messages-single.html">Rationally this was no enjoy fault or
                                            trivial, teachings there has builder and laborious can there not pain. Is
                                            enjoy painful was it take, dislikes actual in from actual a give a
                                            desires...</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="nk-social-messages-description">
                                    ...
                                    <a href="#" class="nk-social-messages-favorite"><span
                                                class="ion-android-star"></span></a>
                                    <div class="nk-social-messages-from">
                                        <a href="#"><img src="assets/images/avatar-4-sm.jpg" alt="Luke"
                                                         title="Luke"></a>
                                    </div>
                                    <div class="nk-social-messages-subject">
                                        <a href="social-user-messages-single.html">Expound exercise</a>
                                    </div>
                                    <div class="nk-social-messages-excerpt">
                                        <a href="social-user-messages-single.html">Yes!</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="nk-social-messages-description">
                                    ...
                                    <div class="nk-social-messages-subject">
                                        <a href="social-user-messages-single.html">Rationally this was no enjoy</a>
                                    </div>
                                    <div class="nk-social-messages-excerpt">
                                        <a href="social-user-messages-single.html">There account that how idea</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
