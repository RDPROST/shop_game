...
<head>
    ...
    <title>GODLIKE | Video Blog Post</title>
...
<div class="nk-main">
    ...
    <div class="nk-header-title nk-header-title-md nk-header-title-parallax nk-header-title-parallax-opacity nk-header-title-boxed">
        <div class="bg-image op-5">
            <img src="assets/images/post-2.jpg" alt="" class="jarallax-img">
        </div>
                    ...
                    <div class="nk-header-text">
                        ...
                        <div class="row text-left">
                            <div class="col-lg-8 order-lg-2">
                                ...
                                <h1 class="nk-title">Video Blog Post</h1>
            ...
            <div class="col-lg-8 order-lg-2">
                <div class="nk-blog-container nk-blog-container-offset">
                    ...
                    <div class="nk-blog-post nk-blog-post-single">
                        <div class="nk-plain-video" data-video="https://www.youtube.com/watch?v=0J4u1FD87FM"></div>
