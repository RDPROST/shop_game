...
<head>
    ...
    <title>GODLIKE | Shopping Cart</title>
...
<div class="nk-main">
    ...
    <div class="container">
        ...
        <div class="nk-store nk-store-cart">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table nk-store-cart-products">
                        ...
                        <tr>
                            ...
                            <td class="nk-product-cart-quantity">
                                <div class="nk-form-control-number">
                                    <input type="number" min="1" max="14" name="quantity" value="1"
                                           class="form-control">
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="nk-product-cart-quantity">
                                <div class="nk-form-control-number">
                                    <input type="number" min="1" max="14" name="quantity" value="2"
                                           class="form-control">
                                </div>
                            </td>
                            <td class="nk-product-cart-total">
                ...
                <div class="col-md-6">
                    ...
                    <div class="nk-box-3 bg-dark-1">
                        ...
                        <form action="#" class="nk-form nk-form-style-1">
                            ...
                            <div class="nk-gap-2"></div>
                            <a class="nk-btn nk-btn-lg link-effect-4 float-right" href="#"><span class="icon"><span
                                            class="ion-refresh"></span></span> Update Totals</a>
                        </form>
                    </div>
            ...
            <div class="nk-gap-2"></div>
            <a class="nk-btn nk-btn-lg link-effect-4 float-right" href="store-checkout.php">Proceed to Checkout</a>
