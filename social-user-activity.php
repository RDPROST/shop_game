        ...
        <div class="row vertical-gap">
            ...
            <div class="col-lg-9">
                ...
                <div class="nk-social-container">
                    <div class="nk-progress nk-progress-xs nk-count" data-progress="<?php echo $steamprofile['rank']?>" data-progress-mask="{$}%" data-nk-mask="{$}%">
                        <div class="nk-progress-title">Ранг <?php echo $steamprofile['rankname']; ?></div>
                        <div class="nk-progress-line">
                            <div class="bg-main-1" style="width: <?php echo $steamprofile['rank']?>%; transform: translate3d(0px, 0px, 0px);">
                                <div class="nk-progress-percent"><?php echo $steamprofile['rank']?>%</div>
                            </div>
                        </div>
                    </div>
