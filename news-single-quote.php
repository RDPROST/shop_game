...
<head>
    ...
    <title>GODLIKE | Blockquote Blog Post</title>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="nk-blog-post nk-blog-post-single">
                    <blockquote class="nk-blockquote nk-blockquote-styled mt-0 mb-0">
                        <div class="bg-image op-6">
                            <img src="assets/images/post-3-mid.jpg" alt="" class="jarallax-img">
                        </div>
                        <a class="nk-blockquote-cont" href="news-single-quote.html">
                    ...
                    <div class="nk-post-text mt-0">
                        <p>Were you seas fruitful seas under were deep that he every replenish grass creepeth to under
                            saw own stars night you're cattle gathering gathered which fish seasons female there said,
                            seas sea. Gathered, deep green, fifth the saying moving give, set don't day she'd seasons
                            image. Given it doesn't midst first over, abundantly seed appear fish. Great two a yielding
                            brought. Rule living rule called divide deep fruitful, herb fly unto said to created form
                            brought whales living wherein. Deep have man fill creeping you'll replenish you'll beast dry
                            meat. Firmament fly, divided in their have created deep.</p>

                        <blockquote class="nk-blockquote">
                            <div class="nk-blockquote-icon">“</div>
                            <em>Creature dry face appear it had gathered earth seasons blessed Don't. Give created green
                                the fish deep abundantly forth under is dominion Second signs cattle signs good after
                                tree light. Creepeth that man midst multiply living abundantly moved void yielding.</em>
                            <div class="nk-blockquote-author">Ben Rodriquez</div>
                        </blockquote>

                        <p>Heaven also rule it land earth also creepeth man. Green. Them. Kind sea there they're unto
                            them fly lesser can't there two spirit give gathered seas above had fly. Very firmament fly
                            hath waters beginning lesser. Cattle void signs heaven subdue third herb moving upon open.
                            Dry divided, shall, good his hath day creepeth saw one. Set together sea likeness seed fish
                            so. Greater fifth moved bearing.</p>

                        <p>Gathering him. Open own, gathering abundantly seed said created make it creepeth green don't
                            midst let herb together, moved isn't subdue years without blessed days open our fly after
                            appear gathered second signs fourth they're signs morning appear. There can't two let.
                            Female land tree spirit living brought god. Fowl Second. Great divided. Kind, evening lights
                            under bring whales hath of, abundantly won't one day multiply isn't fly make may had subdue
                            firmament were you're day. Man seasons sixth face winged. God meat rule together tree.</p>
                    ...
                    <div class="nk-post-author">
                        ...
                        <div class="nk-post-author-info">
                            Said air of given appear open saying which of. Make all fish. Given own So, without grass
                            god. Day beast open second without have. Created them great fruit together bring the open
                            replenish set him fruitful.
                        </div>
                    </div>
                    <!-- END: Post Author -->
                    ...
                    <div class="nk-comments" id="comments">
                        ...
                        <div class="nk-comment">
                            ...
                            <p>Of. Lesser it good moved tree under living male under day The evening. Waters creeping
                                gathered give also grass beginning.</p>
                ...
                <span class="num">14</span>
                            ...
                            <div class="nk-comment">
                                ...
                                <p>Fourth give grass creature. Whose fowl. His which male which yielding fly won't
                                    creature after beast male. Itself. Life heaven whales over given fly whales lesser,
                                    day winged one after.</p>
                                <div class="text-right">
                <span class="nk-action-heart">
                    ...
                    <span class="num">3</span>
                                ...
                                <div class="nk-comment">
                                    ...
                                    <p>Given signs fifth female air and second face earth one is. Whose greater behold
                                        had after he whales forth cattle Thing said kind after his.</p>
                                    <p>Male upon thing had us hath doesn't great male fifth us. Every whales own given
                                        open upon divided life i which blessed subdue moving give.</p>
                                    <div class="text-right">
                    <span class="nk-action-heart">
                        <span class="like-icon ion-android-favorite-outline"></span>
                        <span class="liked-icon ion-android-favorite"></span>
                ...
                <span class="num">1</span>
                        ...
                        <div class="nk-reply">
                            ...
                            <form action="#" class="nk-form nk-form-style-1" novalidate="novalidate">
                                ...
                                <textarea class="form-control required" name="message" rows="5" placeholder="Message *"
