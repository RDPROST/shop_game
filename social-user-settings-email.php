                    ...
                    <form action="#">
                        ...
                        <div class="table-responsive nk-social-settings-table">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <tr>
                                    <td class="nk-social-settings-table-title">A member mentions you in an update using
                                        "@nkdevv"
                                    </td>
                                    <td class="nk-social-settings-table-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="notification1"
                                ...
                                <tr>
                                    <td class="nk-social-settings-table-title">A member replies to an update or comment
                                        you've posted
                                    </td>
                                    <td class="nk-social-settings-table-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="notification2"
                                                   value="yes" checked="checked">
                                        </label>
                                        <span class="sr-only">Yes, send email</span>
                                    </td>
                        ...
                        <div class="table-responsive nk-social-settings-table">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="nk-social-settings-table-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="notification3"
                                                   value="yes" checked="checked">
                                        </label>
                                        <span class="sr-only">Yes, send email</span>
                                    </td>
                        ...
                        <div class="table-responsive nk-social-settings-table">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <tr>
                                    <td class="nk-social-settings-table-title">A member sends you a friendship request
                                    </td>
                                    <td class="nk-social-settings-table-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="notification4"
                                                   value="yes" checked="checked">
                                        </label>
                                        <span class="sr-only">Yes, send email</span>
                                    </td>
                                ...
                                <tr>
                                    <td class="nk-social-settings-table-title">A member accepts your friendship
                                        request
                                    </td>
                                    <td class="nk-social-settings-table-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="notification5"
                                                   value="yes" checked="checked">
                                        </label>
                                        <span class="sr-only">Yes, send email</span>
                                    </td>
