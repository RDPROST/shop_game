...
<head>
    ...
    <title>GODLIKE | Testimonials</title>
        ...
        <div class="nk-header-table">
            <div class="nk-header-table-cell">
                <div class="container">
                    ...
                    <h1 class="nk-title">Testimonials</h1>
            ...
            <div class="row vertical-gap lg-gap">
                <div class="col-md-6">
                    <blockquote class="nk-testimonial-2">
                        ...
                        <div class="nk-testimonial-body">
                            <em>"Grass isn't. Created seed and very Subdue third have he waters void isn't lights
                                divided over give there creeping she'd. She'd, firmament bearing herb them of. Under
                                second brought is stars is very fifth herb also herb above own green."</em>
                        </div>
                        <div class="nk-testimonial-name h4">Kurt Tucker</div>
                        <div class="nk-testimonial-source">CEO, Envato</div>
                    </blockquote>
                ...
                <div class="col-md-6">
                    <blockquote class="nk-testimonial-2">
                        ...
                        <div class="nk-testimonial-body">
                            <em>"Fifth is beast whales living divided upon us brought that his, in deep made evening
                                won't whose may, from Air us stars divide place saw Stars light make they're rule also
                                creeping to darkness together deep without. Firmament lights very."</em>
                        </div>
                        <div class="nk-testimonial-name h4">Katie Anderson</div>
                        <div class="nk-testimonial-source">Frontend Developer, Twitter</div>
                    </blockquote>
                </div>
            </div>
        </div>
