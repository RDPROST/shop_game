...
<head>
    ...
    <title>GODLIKE | GIF Animations</title>
    ...
    <div class="nk-header-table">
        <div class="nk-header-table-cell">
            <div class="container">
                    ...
                    <h1 class="nk-title">GIF Animations</h1>
                
                
                    <h2 class="nk-sub-title">Play on mouse over, click and autoplay</h2>
...
<!-- END: Header Title -->
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 offset-md-2">
                    <h2 class="nk-title">Autoplay GIF</h2>
                </div>
                <div class="col-md-3">
                    <!-- START: Autoplay GIF -->
                    <div class="nk-gif">
    ...
    <div class="nk-box bg-dark-1 text-white">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 offset-md-2">
                    <h2 class="nk-title">Mouse Over GIF</h2>
                </div>
                <div class="col-md-3">
                    <!-- START: Mouse Over GIF -->
                    <div class="nk-gif nk-gif-hover">
                        <img src="assets/images/gif-3-s.gif" data-gif="assets/images/gif-3.gif" alt="">
                    </div>
                    <!-- END: Mouse Over GIF -->
                </div>
            </div>
    ...
    <div class="nk-box">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-5 offset-md-2">
                    <h2 class="nk-title">Click GIF</h2>
                </div>
                <div class="col-md-3">
                    <!-- START: Click GIF -->
                    <div class="nk-gif nk-gif-click">
                        <img src="assets/images/gif-1-s.gif" data-gif="assets/images/gif-1.gif" alt="">
                    </div>
                    <!-- END: Click GIF -->
                </div>
            </div>
    ...
    <div class="nk-box bg-dark-1 text-white">
        ...
        <div class="container">
            <h2 class="nk-title text-center">Play in Viewport</h2>
