...
<head>
    ...
    <title>GODLIKE | Pagination</title>
    ...
    <div class="nk-header-table">
        <div class="nk-header-table-cell">
            <div class="container">
                    ...
                    <h1 class="nk-title">Pagination</h1>
...
<!-- END: Header Title -->
    ...
    <div class="container">
        ...
        <!-- START: Pagination 7 -->
        <div class="nk-pagination nk-pagination-right">
            <nav>
                <a href="#">1</a>
                <a href="#">2</a>
                <a class="nk-pagination-current-white" href="#">3</a>
        ...
        <!-- START: Pagination 8 -->
        <div class="nk-pagination nk-pagination-center">
            <a href="#!" class="nk-btn nk-btn-lg nk-btn-circle link-effect-4">Load More ...</a>
        </div>
        <!-- END: Pagination 8 -->
    </div>
