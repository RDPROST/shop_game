...
<head>
    ...
    <title>GODLIKE | Info Boxes / Alerts</title>
...
<div class="nk-main">
        ...
        <div class="nk-header-table">
            <div class="nk-header-table-cell">
                <div class="container">
                    ...
                    <h1 class="nk-title">Info Boxes / Alerts</h1>
    ...
    <div class="container">
        ...
        <div class="nk-info-box bg-main-1">
            ...
            Thing place. In lesser waters creepeth his place us give multiply fruitful under. Make. Also were, you're
            make make likeness.
        </div>
        <!-- END: Info Box 1 -->
        ...
        <div class="nk-info-box bg-danger">
            ...
            Hath days lesser meat signs very. Fruit second can't moved seas meat two. Grass face isn't forth firmament
            dry. Don't.
        </div>
        <!-- END: Info Box 2 -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="nk-info-box bg-info">
                    ...
                    Hath days lesser meat signs very. Fruit second can't moved seas meat two. Grass face isn't forth
                    firmament dry. Don't.
            ...
            <div class="col-md-6">
                <div class="nk-info-box bg-main-3">
                    ...
                    Grass his itself. Subdue lesser have without female deep set tree together fourth under brought
                    don't seasons seed saw third.
                    <div class="nk-gap"></div>
                    <a href="#" class="nk-info-box-close nk-btn nk-btn-lg link-effect-4 nk-btn-circle">Got It</a>
                </div>
            </div>
        </div>
        <!-- END: Info Box 3 -->
