...
<div class="nk-main">
    ...
    <div class="text-center">
        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target="#myModal">Launch Demo Modal</button>
    </div>

    <div class="nk-gap-4"></div>
    <div class="text-center">
        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".bd-example-modal-lg">Launch Large Modal
        </button>
    </div>

    <div class="nk-gap-4"></div>
    <div class="text-center">
        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".bd-example-modal-lg">Launch Small Modal
        </button>
    </div>
    <div class="nk-gap-4"></div>
    <div class="nk-gap-4"></div>
...
<!-- START: Modal -->
<div id="myModal" class="modal nk-modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title nk-title" id="myModalLabel">Modal title</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="nk-btn nk-btn-color-main-1">Save changes</button>
            </div>
...
<!-- START: Large Modal -->
<div class="modal nk-modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
...
<!-- START: Small Modal -->
<div class="modal nk-modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title nk-title" id="mySmallModalLabel">Small modal</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span class="ion-android-close"></span>
                </button>
            </div>
