...
<!-- END: Header Title -->
    ...
    <div class="nk-gap-4"></div>
    <div class="text-center">
        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".bd-example-modal-lg">Launch Large Modal</button>
    </div>

    <div class="nk-gap-4"></div>
    <div class="text-center">
        <button class="nk-btn nk-btn-x2" data-toggle="modal" data-target=".bd-example-modal-lg">Launch Small Modal</button>
    </div>
    <div class="nk-gap-4"></div>
    <div class="nk-gap-4"></div>
...
<!-- END: Footer -->
    ...
    <!-- START: Small Modal -->
    <div class="modal nk-modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
