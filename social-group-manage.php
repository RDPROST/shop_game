...
<head>
    ...
    <title>GODLIKE | Social Network - Group Manage</title>
                ...
                <div class="nk-social-container">
                    ...
                    <form action="#">
                        <input type="text" class="form-control" name="name" placeholder="Group Name *"
                               value="Game Lovers">
                        <div class="nk-gap-2"></div>
                        <textarea type="text" class="form-control" name="description" placeholder="Group Description *"
                                  rows="5">Have created Darkness she'd deep night Isn't and blessed day brought be female don't spirit won't sea so them image you be whales bring stars good thing bearing. Darkness blessed creeping moved.</textarea>
