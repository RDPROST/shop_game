...
<head>
    ...
    <title>GODLIKE | Social Network - Single Message</title>
        ...
        <div class="row vertical-gap">
            ...
            <div class="col-lg-9">
                ...
                <div class="nk-social-container">
                    ...
                    <h2>Hey, man!</h2>
                    <div>
                        <em>Conversation between <a href="#">John</a> and you.</em>
                        <a class="nk-btn nk-btn-xs float-right" href="#" title="Delete Conversation">Delete</a>
                    </div>

                    <div class="nk-social-messages-single">
                        <div class="nk-social-messages-single-avatar">
                        ...
                        <div class="nk-social-messages-single-content">
                            <div class="nk-social-messages-single-meta">
                                <a href="#" class="nk-social-messages-single-meta-name">nK</a> Sent <a href="#"
                                                                                                       class="nk-social-messages-single-meta-time">6
                                    days ago</a>
                                <a href="#" class="nk-social-messages-single-meta-favorite"><span
                    ...
                    <div class="nk-social-messages-single">
                        ...
                        <div class="nk-social-messages-single-content">
                            <div class="nk-social-messages-single-meta">
                                <a href="#" class="nk-social-messages-single-meta-name">John</a> Sent <a href="#"
                                                                                                         class="nk-social-messages-single-meta-time">2
                                    days ago</a>
                                <a href="#" class="nk-social-messages-single-meta-favorite"><span
                                            class="ion-android-star"></span></a>
                            </div>
                            <div class="nk-social-messages-single-text">
                                Again all builder annoying enjoy anyone teachings rejects and can obtain those. Us,
                                pursue laborious toil wrong do point avoid by fruit learn or in death. So passage
                                however besides invited comfort elderly be me. Walls began of child civil am heard hoped
                                my. Satisfied pretended mr on do determine by. Old post took and ask seen fact rich. Man
                                entrance settling believed eat joy. Money as drift begin on to. Comparison up insipidity
                    ...
                    <div class="nk-social-messages-single">
                        ...
                        <div class="nk-social-messages-single-content">
                            <div class="nk-social-messages-single-text">
                                <form action="#">
                                    <textarea class="form-control" placeholder="Send a Reply" rows="4"></textarea>
                                    <div class="nk-gap"></div>
                                    <button class="nk-btn link-effect-4 float-right">Send Reply</button>
                                </form>
                            </div>
                        </div>
                    </div>
