                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-1-sm.png" alt="Women Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-1-blue-sm.png" alt="Women Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-1-green-sm.png" alt="Women Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-1-orange-sm.png" alt="Women Tshirt">
                                            </div></div>
                                        
                                    </div>
                                </div>
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Women Tshirt</a></h2>
                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-2-sm.png" alt="Men Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-2-blue-sm.png" alt="Men Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-2-green-sm.png" alt="Men Tshirt">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-2-orange-sm.png" alt="Men Tshirt">
                                            </div></div>
                                        
                                    </div>
                                </div>
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Men Tshirt</a></h2>
                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-3-sm.png" alt="Women Hoodie">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-3-blue-sm.png" alt="Women Hoodie">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-3-green-sm.png" alt="Women Hoodie">
                                            </div></div>
                                        
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-3-orange-sm.png" alt="Women Hoodie">
                                            </div></div>
                                        
                                    </div>
                                </div>
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Women Hoodie</a></h2>
                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-4-sm.png" alt="Men Hoodie">
                                            </div></div>
                                ...
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Men Hoodie</a></h2>
                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-5-sm.png" alt="Women Cap">
                                            </div></div>
                                ...
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Women Cap</a></h2>
                            ...
                            <div>
                                <div class="nk-carousel-3" data-size="1" data-mouse-parallax-z="3">
                                    <div class="nk-carousel-inner nk-popup-gallery">
                                            ...
                                            <div><div>
                                                <img class="nk-img-stretch" src="assets/images/product-6-sm.png" alt="Men Cap">
                                            </div></div>
                                ...
                                <h2 class="nk-product-title h5" data-mouse-parallax-z="1"><a href="store-product.php">Men Cap</a></h2>
