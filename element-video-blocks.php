...
<div class="nk-main">
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    <p>From whose spirit bearing sixth. Bring blessed grass, there <em>void</em> dry you&#39;ll. Bring
                        spirit waters cattle <strong>of</strong> cattle deep were likeness which saying you fowl Herb
                        whose seasons blessed signs had. Under.</p>
                </div>
            </div>
        </div>
            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-6">
                    <div class="nk-plain-video">
                        <iframe src="https://www.youtube.com/embed/3XP0nyLz6Y8" width="500" height="281" frameborder="0"
    ...
    <div class="nk-box bg-dark-1 text-white">
        ...
        <div class="bg-video-row row justify-content-end">
            <div class="col-lg-6">
                <div class="bg-video bg-video-parallax"
                     style="background-image: url('assets/images/image-3.jpg');"></div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="nk-gap"></div>
                    <p>Green him, greater you earth earth. Likeness moving won&#39;t us from us lesser for Air is to day
                        him beginning gathered replenish blessed saw hath don&#39;t creature to.</p>
                    <p>Their tree there yielding thing form. Evening two dry said. Have signs days greater fly also
                        <strong>you&#39;re</strong> midst whales. Heaven firmament great moving divided appear for you&#39;ll
                        forth us. Creeping dry, there wherein. Were. Great made they&#39;re. First whales given sixth.
                        Living.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    <div class="nk-gap"></div>
                    <p>Shall wherein were. Dominion fruitful day. Spirit face above In earth image so. Creepeth them,
                        gathered living first Form male <strong>divided</strong> green. Morning one lights waters earth.
                        Bearing. Wherein fill fly <strong>Air</strong> after seasons tree us likeness set deep signs dry
                        <em>forth</em> life god wherein face shall seas. Open god good <em>his</em> third under male man
                        day he blessed creeping air called replenish seas to Gathered kind them. From. Give.</p>
                </div>
            </div>
        </div>
        <div class="nk-gap-5"></div>
