            ...
            <div class="col-lg-8">
                ...
                <div class="nk-blog-list-classic">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-image.html">Image Blog Post</a>
                            </h2>
                            ...
                            <div class="nk-post-text">
                                ...
                                <p>Vel egestas tortor porta rutrum sit nisi luctus blandit accumsan vel eu pharetra
                                    fusce auctor congue phasellus non.</p>
                            </div>
                            <a href="news-single-image.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-video.html">Video Blog Post</a>
                            </h2>
                            <div class="nk-post-date">
                                September 5, 2016
                            </div>
                            <div class="nk-post-text">
                                ...
                                <p>Nunc, eu placerat nisl euismod curae; nam libero sed at facilisis. Elementum eleifend
                                    eros sociis sagittis sociis dignissim vehicula pharetra. Felis curae; phasellus
                                    conubia. Inceptos est magna. Hac, praesent. Hymenaeos enim.</p>
                                <p>Felis fermentum sit quam volutpat aptent. Feugiat posuere duis potenti inceptos
                                    potenti ridiculus ad, dui tristique felis torquent.</p>
                            </div>
                            <a href="news-single-video.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-quote.html">Blockquote Blog Post</a>
                            </h2>
                            <div class="nk-post-date">
                                August 27, 2016
                            </div>
                            ...
                            <a href="news-single-quote.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-audio.html">Audio Blog Post</a>
                            </h2>
                            <div class="nk-post-date">
                                August 14, 2016
                            </div>
                            ...
                            <a href="news-single-audio.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-gallery.html">Gallery Blog Post</a>
                            </h2>
                            <div class="nk-post-date">
                                Jule 23, 2016
                            </div>
                            <div class="nk-post-text">
                                <p>Dictumst eu integer, luctus rutrum ut. Sociis mus integer ultrices velit volutpat
                                    ...
                                    senectus elit tellus proin bibendum ligula fames torquent posuere faucibus egestas
                                    integer et Sit fames aptent congue Cum. Consectetuer quis. Magnis. Consequat.</p>
                                <p>Euismod, pulvinar. Nonummy amet sociosqu libero dictum aptent nisi lobortis porttitor
                                    imperdiet, nunc tristique quisque posuere non torquent duis id sem Mauris fringilla
                                    torquent nulla vitae.</p>
                            </div>
                            <a href="news-single-gallery.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-post-content">
                            <h2 class="nk-post-title h3">
                                <a href="news-single-standard.html">Standard Blog Post</a>
                            </h2>
                            <div class="nk-post-date">
                                Jule 3, 2016
                            </div>
                            <div class="nk-post-text">
                                ...
                                <p>Dolor dis Class eros dapibus imperdiet lobortis dis consequat habitant sociis posuere
                                    est viverra quis natoque luctus fermentum mollis morbi, suspendisse consectetuer
                                    senectus adipiscing ridiculus congue metus curae; quam auctor ante blandit hac.
                                    Phasellus nisi. Aliquam duis ultrices. Cubilia.</p>
                                <p>Consequat a ad sagittis elit neque quisque. Dolor porta fames nam eget auctor
                                    pulvinar odio justo a taciti cursus nisl non malesuada nulla sed. Praesent, nascetur
                                    consequat at Posuere ac ultricies ornare gravida duis, fames dui id. A.</p>
                            </div>
                            <a href="news-single-standard.html" class="nk-btn link-effect-4">Read More</a>
                        </div>
                    </div>
                    <!-- END: Post -->
