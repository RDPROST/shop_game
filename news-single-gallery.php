...
<head>
    ...
    <title>GODLIKE | Gallery Blog Post</title>
...
<div class="nk-main">
    ...
    <div class="nk-header-title nk-header-title-md nk-header-title-parallax nk-header-title-parallax-opacity nk-header-title-boxed">
        <div class="bg-image op-5">
            <img src="assets/images/post-5.jpg" alt="" class="jarallax-img">
        </div>
                    ...
                    <div class="nk-header-text">
                        ...
                        <div class="row text-left">
                            <div class="col-lg-8">
                                ...
                                <h1 class="nk-title">Gallery Blog Post</h1>
                    ...
                    <div class="nk-blog-post nk-blog-post-single">
                        <div class="nk-carousel-3" data-arrows="true" data-size="1" data-autoplay="8000">
                            <div class="nk-carousel-inner nk-popup-gallery">
                                ...
                                <div>
                                    <div>
                                        <a href="assets/images/post-5.jpg" class="nk-gallery-item"
                                           data-size="1920x1280"><img src="assets/images/post-5-mid.jpg" alt=""></a>
                                    </div>
                                </div>

                                <div>
                                    <div>
                                        <a href="assets/images/post-6.jpg" class="nk-gallery-item"
                                           data-size="1920x1280"><img src="assets/images/post-6-mid.jpg" alt=""></a>
                                    </div>
                                </div>

                                <div>
                                    <div>
                                        <a href="assets/images/post-7.jpg" class="nk-gallery-item"
                                           data-size="1920x1280"><img src="assets/images/post-7-mid.jpg" alt=""></a>
                                    </div>
                                </div>
                        ...
                        <div class="nk-post-text mt-0">
                            ...
                            <blockquote class="nk-blockquote">
                                ...
                                <em>Creature dry face appear it had gathered earth seasons blessed Don't. Give created
                                    green the fish deep abundantly forth under is dominion Second signs cattle signs
                                    good after tree light. Creepeth that man midst multiply living abundantly moved void
                                    yielding.</em>
