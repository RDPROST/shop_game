        ...
        <div class="row vertical-gap">
            ...
            <div class="col-lg-9">
                ...
                <div class="nk-social-menu-inline">
                    <ul>
                        <li class="active">
                            <a href="social-user-groups.html">Membershipt</a>
                        </li>
                        <li>
                            ...
                            <div class="nk-social-groups-content">
                                <div class="nk-social-groups-info">
                                    ...
                                    <div class="nk-social-groups-description">
                                        Truth but resultant toil mistaken expound chooses example can is, right no which
                                        idea praising itself of, but not, explain advantage, ever circumstances, except
                                    </div>
                                </div>
                        ...
                        <li>
                            ...
                            <div class="nk-social-groups-content">
                                <div class="nk-social-groups-info">
                                    ...
                                    <div class="nk-social-groups-description">
                                        One praising truth, procure example loves pain complete but are, and, can
                                        expound builder which know rationally with. Not, produces you not take system
                                        master is - because fault and advantage, complete
                                    </div>
                                </div>
                                <div class="nk-social-groups-actions">
                                    <a href="#" class="nk-btn nk-btn-xs link-effect-4">Leave Group</a>
